...
Magični kvadrat v litografiji Melancholia I (glej sliko \ref{magicnikvadrat}
...
(glej sliko \ref{Sagradafamilia} za fotografijo) vsebuje magični kvadrat reda 4.
% sklic: fig:sagrada
...
\begin{izrek}
      ...
      Magična konstanta normalnega magičnega kvadrata reda \begin{equation}
         M_2(n) = \frac{1}{2} 2n(n2 + 1)
      \end{equation}
      je enaka
      \begin{equation}
         % oznaka: eq:mc
...
Števila različnih normalnih magičnih kvadratov se nahajajo v tabeli \ref{tabela7}.
% sklic: table:stevila
